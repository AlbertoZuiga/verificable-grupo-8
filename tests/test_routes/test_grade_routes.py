...
class TestGradeAssignment:
    def test_assign_new_grade_success(
        self, client, test_student_in_section, test_evaluation_instance
    ):
        url = url_for(
    ...
    def test_update_existing_grade(self, client, test_grade, test_student_in_section):
        url = url_for(
            "grades.assign_or_edit_grade",
    ...
    def test_assign_grade_closed_section(
        self, client, test_evaluation_instance_closed_section, test_student_in_closed_section
    ):
        with client:
            url = url_for(
                "grades.assign_or_edit_grade",
    ...
    def test_assign_grade_invalid_student(
        self, client, test_evaluation_instance, test_student_not_in_section
    ):
        url = url_for(
            "grades.assign_or_edit_grade",
            evaluation_instance_id=test_evaluation_instance.id,
    ...
    def test_grade_transaction_error(
        self, mock_save, client, test_student_in_section, test_evaluation_instance
    ):
...
class TestGradeDeletion:
    def test_delete_grade_success(self, client, test_grade):
        url = url_for(
            "grades.delete_grade",
            evaluation_instance_id=test_grade.evaluation_instance_id,
            student_id=test_grade.student_id,
    ...
    def test_delete_nonexistent_grade(self, client, test_evaluation_instance, test_student):
        url = url_for(
            "grades.delete_grade",
            evaluation_instance_id=test_evaluation_instance.id,
    ...
    def test_delete_grade_db_error(self, mock_commit, client, test_grade):
