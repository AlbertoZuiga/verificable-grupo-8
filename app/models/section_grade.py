...
class SectionGrade(kanvas_db.Model):
    ...
    student_id = kanvas_db.Column(kanvas_db.Integer, kanvas_db.ForeignKey('students.id'), nullable=False)
    section_id = kanvas_db.Column(kanvas_db.Integer, kanvas_db.ForeignKey('sections.id'), nullable=False)
