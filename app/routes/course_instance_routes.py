...
def create():
    ...
    if form.validate_on_submit():
        ...
        if CourseInstance.query.filter_by(course_id=course_id, year=year, semester=semester).first():
        ...
        new_course_instance = CourseInstance(course_id=course_id, year=year, semester=Semester[semester])
